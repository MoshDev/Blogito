object Depends {
  ...
  object PaperParcel {
    val runtime = "nz.bradcampbell:paperparcel:${Versions.PaperParcel.version}"
    val kotlin = "nz.bradcampbell:paperparcel-kotlin:${Versions.PaperParcel.version}"
    val compiler = "nz.bradcampbell:paperparcel-compiler:${Versions.PaperParcel.version}"
  }
}